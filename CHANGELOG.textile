...
* [WCR] As get_invoices doesn't download the attached line items, add code to automatically request line items from Xero the first time XeroGateway::Invoice#line_items is accessed. *
* [WCR] Populate XeroGateway::Payment class with results from invoice/s including new invoice fields for payment status. *
* [WCR] Modify XeroGateway::LineItem to store multiple tracking items.
...
* [WCR] Add XeroGateway::Gateway#create_invoices
